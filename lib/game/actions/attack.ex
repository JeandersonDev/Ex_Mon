defmodule ExMon.Game.Actions.Attack do
  ...
  def attack_opponent(opponent, move) do
    ...
    |> update_opponent_life(opponent, damage, move)
  ...
  defp update_opponent_life(life, opponent, damage, move) do
    opponent
    |> Game.fetch_player()
    |> Map.put(:life, life)
    |> update_game(opponent, damage, move)
  end

  defp update_game(player, opponent, damage, move) do
    Game.info()
    |> Map.put(opponent, player)
    |> Game.update()

    Status.print_move_message(opponent, :attack, damage, move)
    Game.info()
  end
end
